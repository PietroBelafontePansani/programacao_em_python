...
subtraia = (10 - 2)*5
print('resultado', subtraia)

divida = (27 / 3)+5
print('resultado', divida)
...
# concatenação -  juntar dados - literal variavel 
...
# Refatoração identificar erros de bugs 
